...
(function($) {
	"use strict";
		...
		$('#clock-countdown').countdown('2017/01/15 12:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>天</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>時</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>分</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>秒</span></div></div>'
			));
		});
